...
import { IconSquareRoundedArrowLeft } from "@tabler/icons";
...
const SideBar: React.FC = (): JSX.Element => {
	return (
		<div className="relative flex flex-col basis-[385px] shrink-0 bg-[rgba(0,0,0,0.424)] border-r border-solid border-r-white">
			<div className="w-full min-h-[150px] flex basis-[25%] flex-col items-center justify-center">
				<Center className="w-full min-h-[50px] top-0 absolute justify-start pl-5">
					<Link
